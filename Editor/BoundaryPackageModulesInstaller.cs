...
namespace RealityToolkit.Boundary.Editor
{
    ...
    public sealed class BoundaryPackageModulesInstaller : IPackageModulesInstaller
    {
        ...
        {
            if (!typeof(IBoundaryModule).IsAssignableFrom(serviceConfiguration.InstancedType.Type))
            {
            ...
            if (!ServiceManager.Instance.TryGetServiceProfile<IBoundary, BoundaryProfile>(out var BoundaryProfile))
            {
            ...
            var typedServiceConfiguration = new ServiceConfiguration<IBoundaryModule>(serviceConfiguration.InstancedType.Type, serviceConfiguration.Name, serviceConfiguration.Priority, serviceConfiguration.RuntimePlatforms, serviceConfiguration.Profile);
